...
import { Oswald, Inter, Space_Mono, Noto_Sans_SC } from "next/font/google";
...
import { PrepProvider } from "@/stores/prep-store";
import { SideDrawerProvider } from "@/components/shell/side-drawer";
import { DemoFloatingEntry } from "@/components/shell/demo-floating-entry";
import { getServerLocale } from "@/lib/i18n/server-preference";

const inter = Inter({ subsets: ["latin"], variable: "--font-sans" });
const oswald = Oswald({ subsets: ["latin"], weight: ["500", "600", "700"], variable: "--font-heading" });
const spaceMono = Space_Mono({ subsets: ["latin"], weight: ["400", "700"], variable: "--font-mono" });
const notoSansSC = Noto_Sans_SC({ subsets: ["latin"], weight: ["400", "500", "700"], variable: "--font-cjk" });
...
export default async function RootLayout({
  ...
  return (
    <html
      ...
      className={cn("h-full antialiased", "font-sans", inter.variable, oswald.variable, spaceMono.variable, notoSansSC.variable)}
    >
      <body
      ...
      >
        <I18nProvider>
          <EazoProvider>
            ...
            <UserSyncEffect />
            <PrepProvider>
              <SideDrawerProvider>{children}</SideDrawerProvider>
            </PrepProvider>
            <DemoFloatingEntry />
            <Toaster />
